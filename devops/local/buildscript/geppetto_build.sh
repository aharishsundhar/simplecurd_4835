...
DESKTOPCODE='../../../application/client/desktop/simplecurd_4835'
DESKTOPIMAGENAME='geppettotest/simplecurd_4835-desktop:1.0'
...
helm install --name simplecurd_4835 ./helm
if [ $? -eq 0 ]; then
